...
router.get('/create-link', function (req, res) {
  let domain = "http://localhost:3007";
  let dataExcel = [];
  User.find({})
    .then(users => {
      let demo2 = [];
      ...
      // ghi ra file users.xlsx theo đường dẫn public/exports
      // tạo 1 liên kết trỏ tới file đó và gửi nó sang trang receive đính kèm theo link
